...
const EngagementTrendChart = ({ data, title }) => {
  ...
  return (
    <div className="relative bg-neutral-900 border border-neutral-700 rounded-xl p-4 sm:p-6 overflow-hidden">
      <h3 className="text-lg font-bold text-white tracking-wider mb-4">{title}</h3>
      <div className="w-full overflow-x-auto">
        <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} className="min-w-[300px] block">
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-wider">KNOW YOUR ENGAGEMENT RATE</h1>
          <p className="text-sm text-neutral-400">Calculate your influencer engagement rate across platforms</p>
        </div>
      </div>
      ...
      <Card className="bg-neutral-900 border-neutral-700">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            >
              <SelectTrigger className="bg-neutral-800 border-neutral-600 text-white text-sm w-full">
              ...
              {platformInputs[selectedPlatform]?.map((input) => (
                <div key={input.id}>
                  ...
                  <Input
                    ...
                    className="bg-neutral-800 border-neutral-600 text-white placeholder-neutral-400 text-sm w-full"
                  />
                </div>
              ))}
            </div>
          ...
          <div
            className={cn(
              ...
              showResults ? "max-h-[1000px] opacity-100 pt-4" : "max-h-0 opacity-0",
            )}
          >
            {engagementRate !== null && (
              <div className="space-y-4">
                <div className="text-center">
                  ...
                  <p className={cn("text-3xl sm:text-4xl font-bold font-mono", getStatusColor(engagementStatus))}>
                    {engagementRate.toFixed(2)}%
                  </p>
                  <Badge className={cn("mt-2 text-sm", getBadgeColor(engagementStatus))}>
                ...
                <div className="w-full bg-neutral-800 rounded-full h-2 mt-4">
                  <Progress
                    ...
                    className={cn("h-2", getProgressBarColor(engagementStatus))}
                  />
                </div>

                <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-neutral-400 gap-2 sm:gap-0">
                  <div className="flex items-center gap-1">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="bg-neutral-800 border-neutral-700 text-neutral-300 max-w-xs text-xs">
                          ...
                          {selectedPlatform === "facebook" && <p>(Reactions + Comments + Shares) ÷ Followers × 100</p>}
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                  <span className="text-neutral-500 italic text-center sm:text-right">
