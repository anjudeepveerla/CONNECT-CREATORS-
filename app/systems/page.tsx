  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-wider">SYSTEMS MONITOR</h1>{" "}
          {/* Adjusted font size */}
          <p className="text-sm text-neutral-400">Infrastructure health and performance monitoring</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          {" "}
          {/* Adjusted flex direction and width */}
          <Button className="bg-orange-500 hover:bg-orange-600 text-white w-full sm:w-auto text-sm">System Scan</Button>{" "}
          {/* Adjusted width and font size */}
          <Button className="bg-orange-500 hover:bg-orange-600 text-white w-full sm:w-auto text-sm">
            Maintenance Mode
          </Button>{" "}
          {/* Adjusted width and font size */}
        </div>
          ...
          <CardContent className="p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-white font-mono">24/26</p> {/* Adjusted font size */}
              </div>
              <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-white" /> {/* Adjusted size */}
            </div>
          </CardContent>
        </Card>
        <Card className="bg-neutral-900 border-neutral-700">
          <CardContent className="p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-orange-500 font-mono">3</p> {/* Adjusted font size */}
              </div>
              <AlertTriangle className="w-6 h-6 sm:w-8 sm:h-8 text-orange-500" /> {/* Adjusted size */}
            </div>
          </CardContent>
        </Card>
        <Card className="bg-neutral-900 border-neutral-700">
          <CardContent className="p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-white font-mono">99.7%</p> {/* Adjusted font size */}
              </div>
              <Activity className="w-6 h-6 sm:w-8 sm:h-8 text-white" /> {/* Adjusted size */}
            </div>
          </CardContent>
        </Card>
        <Card className="bg-neutral-900 border-neutral-700">
          <CardContent className="p-3 sm:p-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl sm:text-2xl font-bold text-neutral-300 font-mono">1</p> {/* Adjusted font size */}
              </div>
              <Settings className="w-6 h-6 sm:w-8 sm:h-8 text-neutral-300" /> {/* Adjusted size */}
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      {selectedSystem && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-md sm:max-w-4xl max-h-[90vh] overflow-y-auto">
            {" "}
            {/* Adjusted max-width */}
            <CardHeader className="flex flex-row items-center justify-between pb-3 sm:pb-4">
              ...
              <Button
                ...
                className="text-neutral-400 hover:text-white w-8 h-8 sm:w-auto sm:h-auto" /* Removed extraneous backslash */
              >
                ✕
              </Button>
            </CardHeader>
            <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t border-neutral-700">
                {" "}
                {/* Adjusted flex direction and gap */}
                <Button className="bg-orange-500 hover:bg-orange-600 text-white text-sm w-full sm:w-auto">
                  Restart System
                </Button>{" "}
                {/* Adjusted font size and width */}
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-300 bg-transparent text-sm w-full sm:w-auto" /* Removed extraneous backslash */
                >
                  View Logs
                </Button>
                <Button
